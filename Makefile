...
generate-mocks: install-mock-generators
	...
	mockgen -destination=storage/mocks/storage.go -package=mocks github.com/koko1123/flow-go-1/storage Blocks,Headers,Payloads,Collections,Commits,Events,ServiceEvents,TransactionResults
	mockgen -destination=module/mocks/network.go -package=mocks github.com/koko1123/flow-go-1/module Local,Requester
	mockgen -destination=network/mocknetwork/mock_network.go -package=mocknetwork github.com/koko1123/flow-go-1/network Network
