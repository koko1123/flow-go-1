...
import (
	...
	real "github.com/koko1123/flow-go-1/module/buffer"
	...
	protint "github.com/koko1123/flow-go-1/state/protocol"
...
func (cs *ComplianceCoreSuite) TestProcessBlockAndDescendants() {
	...
	err := cs.core.processBlockAndDescendants(parent, false)
